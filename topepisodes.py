...
def get_episodes(title, season, episode, api_key):
    episode_list = []

    if season != '':
        path = "http://omdbapi.com/?apikey=" + api_key + \
    ...
    path = "http://omdbapi.com/?apikey="+api_key+"&type=series&t=" + title
    r = requests.get(path)
    data = r.json()
...
if __name__ == "__main__":
    ...
    episodes = get_episodes(title, season, episode, api_key)
